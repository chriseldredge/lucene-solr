...
public class TestContextImpl extends AbstractDataImportHandlerTestCase {
  ...
  private ContextImpl createContextWithScript(String scriptTag) throws Exception {
    ...
    DocBuilder docBuilder = new DocBuilder(dataImporter, new SolrWriter(null, null), new SimplePropertiesWriter(), null);
    return new ContextImpl(null, new VariableResolver(), null, "something", new HashMap<String, Object>(), null, docBuilder) {
